...
//
//
//    this.seekCareOutside = 'no',
//    this.wasIllnessSerious= false,
//    this.moneyNotAvailable= false,
//    this.familyMembersNotAbleAccompany= false,
//    this.badWeather= false,
//    this.didNotKnowAboutInfant= false,
//    this.noHopeForSurvival= false,
//    this.transportNotAvailable= false,
//    this.others= '',
//
//    this.quack= false,
//    this.traditionalHealer= false,
//    this.subCentre= false,
//    this.phc= false,
//    this.chc= false,
//    this.subDistrictHospital= false,
//    this.districtGovtHospital= false,
//    this.privateAllopathic= false,
//    this.doctorAlternateSystem= false,
//    this.reasonForSeekingCare= '',
//    this.ashaAdviceOnHospitalTreatment= 'no',
//    this.conditionWhenMedical= 'Active',
//
//
//    this.Hospital = const ["","","",""],
//    this.problem = const ["","","",""],
//    this.timeTaken = const ["","","",""],
//    this.nil = const [false, false, false, false],
//    this.firstAid = const [false, false, false, false],
//    this.otherspecify = const ["","","",""],
//    this.lackOfSpecialists  =  const [false, false, false, false],
//    this.lackOfEquipments  =  const [false, false, false, false],
//    this.othersreason = const ["","","",""],
//    this.transportModeInGovt = const ["","","",""],
//    this.transportModeInPrivate = const ["","","",""],
//    this.reasonForOtherInstitution = const ["","","",""],
//    this.reasonForOtherInstitutionDecision = const ["","","",""],
//    this.timeTakenForTreatment = const ["","","",""],
//
//    this.informalPayment,
//    this.mobilizingSpecialists,
//    this.workersNotAvailable,
//    this.patientRush,
//    this.doctorNotAvailable,
//    this.moneyProblem,
//    this.investigationsNotDone,
//    this.otherProblem = const ["","","",""],
//
//
//    this.reasonDischargedAgainstMedicalAdvice = "",
//    this.dischargedAgainstMedicalAdvice = "no",
//    this.circumstancesDischargeBaby = "",
//    this.dischargeOnBehalf = "",
//    this.babyDiedBeforeDischarge = "no",
//    this.dischargeDueDissatisfactionTreatment = "no",
//    this.reasonAgainstdischargedMedicalAdvice = "",
//
//
//    this.wasGirlInfant = "no",
//    this.ifGirlWasBoy = "",
//    this.alcohol,
//    this.tobacco,
//    this.domesticAbuseMother = false,
//
//    this.dangerSignsWhenNewborn = "no",
//    this.listItem,
//    this.hospitalWhereNewbornTreated = "no",
//    this.nameOfFacilities = "",
//
//
//    this.treatment = 0,
//    this.transport = 0,
